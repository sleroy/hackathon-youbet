...
/**
 * This mapper stores all the records for training the prediction engine.
 */
public interface MatchRecordMapper {
    
    @Insert("INSERT INTO MatchRecord\n" +
            "(country_id, league_id, season, `date`, home_team_api_id, away_team_api_id, score_team_home, score_team_away, home_player_X1, home_player_X2, home_player_X3, home_player_X4, home_player_X5, home_player_X6, home_player_X7, home_player_X8, home_player_X9, home_player_X10, home_player_X11, away_player_X1, away_player_X2, away_player_X3, away_player_X4, away_player_X5, away_player_X6, away_player_X7, away_player_X8, away_player_X9, away_player_X10, away_player_X11, home_player_Y1, home_player_Y2, home_player_Y3, home_player_Y4, home_player_Y5, home_player_Y6, home_player_Y7, home_player_Y8, home_player_Y9, home_player_Y10, home_player_Y11, away_player_Y1, away_player_Y2, away_player_Y3, away_player_Y4, away_player_Y5, away_player_Y6, away_player_Y7, away_player_Y8, away_player_Y9, away_player_Y10, away_player_Y11, home_player_1, home_player_2, home_player_3, home_player_4, home_player_5, home_player_6, home_player_7, home_player_8, home_player_9, home_player_10, home_player_11, away_player_1, away_player_2, away_player_3, away_player_4, away_player_5, away_player_6, away_player_7, away_player_8, away_player_9, away_player_10, away_player_11)\n" +
            "VALUES(#{country_id}, #{league_id}, #{season}, #{date}, #{home_team_api_id}, #{away_team_api_id}, #{score_team_home}, #{score_team_away}, #{home_player_X1}, #{home_player_X2}, #{home_player_X3}, #{home_player_X4}, #{home_player_X5}, #{home_player_X6}, #{home_player_X7}, #{home_player_X8}, #{home_player_X9}, #{home_player_X10}, #{home_player_X11}, #{away_player_X1}, #{away_player_X2}, #{away_player_X3}, #{away_player_X4}, #{away_player_X5}, #{away_player_X6}, #{away_player_X7}, #{away_player_X8}, #{away_player_X9}, #{away_player_X10}, #{away_player_X11}, #{home_player_Y1}, #{home_player_Y2}, #{home_player_Y3}, #{home_player_Y4}, #{home_player_Y5}, #{home_player_Y6}, #{home_player_Y7}, #{home_player_Y8}, #{home_player_Y9}, #{home_player_Y10}, #{home_player_Y11}, #{away_player_Y1}, #{away_player_Y2}, #{away_player_Y3}, #{away_player_Y4}, #{away_player_Y5}, #{away_player_Y6}, #{away_player_Y7}, #{away_player_Y8}, #{away_player_Y9}, #{away_player_Y10}, #{away_player_Y11}, #{home_player_1}, #{home_player_2}, #{home_player_3}, #{home_player_4}, #{home_player_5}, #{home_player_6}, #{home_player_7}, #{home_player_8}, #{home_player_9}, #{home_player_10}, #{home_player_11}, #{away_player_1}, #{away_player_2}, #{away_player_3}, #{away_player_4}, #{away_player_5}, #{away_player_6}, #{away_player_7}, #{away_player_8}, #{away_player_9}, #{away_player_10}, #{away_player_11});\n")
    @Options(useGeneratedKeys = true, keyProperty = "id", keyColumn = "id")
    int createMatchRecord(MatchRecord player);
    
    @Insert("UPDATE MatchRecord\n" +
            "SET score_team_home=#{home_team_goal}, score_team_away=#{away_team_goal}\n" +
            "WHERE league_id=#{league} AND season=#{season} AND country_id=#{countryId} AND date=#{date};\n")
    void updateMatchRecord(@Param("countryId") Integer countryId,
    ...
    @Select("SELECT * FROM MatchRecord")
    @Results(id = "MatchRecord",
             value = {
